...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    func userTimeline(uidStr: String, refreshing: Bool, sinceId: Int64?, maxId: Int64?, success: @escaping ([Tweet]) -> (), failure: @escaping (Error) -> ()) {
        var parameters = [String : AnyObject]()
        parameters["user_id"] = uidStr as AnyObject
        parameters["count"] = 20 as AnyObject
        ...
        get(AppConstants.userTimeline, parameters: parameters, progress: nil, success: { (task: URLSessionDataTask, response: Any?) in
    ...
    func favoritesTimeline(uidStr: String, refreshing: Bool, sinceId: Int64?, maxId: Int64?, success: @escaping ([Tweet]) -> (), failure: @escaping (Error) -> ()) {
        var parameters = [String : AnyObject]()
        parameters["user_id"] = uidStr as AnyObject
        parameters["count"] = 20 as AnyObject
        ...
        get(AppConstants.favoritesTimeline, parameters: parameters, progress: nil, success: { (task: URLSessionDataTask, response: Any?) in
